# Dirs and files
BASE_URL = './'
RESOURCES_DIR = f'{BASE_URL}resources/'
DATA_PATH = f'{RESOURCES_DIR}df.tsv'
MODEL_DIR = RESOURCES_DIR
MODEL_NAME = 'model.joblib'
MODEL_PATH = MODEL_DIR + MODEL_NAME
EXPORT_OUTPUT = 'bandwidth_linreg_parameters.h'
EXPORT_OUTPUT_PATH = f'{BASE_URL}../browser/{EXPORT_OUTPUT}'
EXPORT_TEMPLATE_NAME = f'{EXPORT_OUTPUT}.tpl'
